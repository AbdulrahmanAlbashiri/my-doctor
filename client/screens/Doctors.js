...
import { Text , ListItem , Avatar ,SearchBar } from 'react-native-elements';
...
export default function DoctorsScreen() {
  ...
  return (
    ...
    <Loader loading={loading} title="جاري احضار الأطباء " />
    <ScrollView>
      ...
      <SafeAreaView>
        { doctors.length !== 0 ?
          ...
          :
          <Text style={styles.noDoctorsText}>لا يوجد أطباء لعرضهم</Text>
        }
      </SafeAreaView>
